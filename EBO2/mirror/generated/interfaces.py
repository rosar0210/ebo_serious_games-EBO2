...
Ice.loadSlice("-I ./generated/ --all ./generated/EboMoods.ice")
...
class Requires:
    def __init__(self, ice_connector:Ice.CommunicatorI, parameters):
        ...
        self.EboMoods = self.create_proxy("EboMoods", RoboCompEboMoods.EboMoodsPrx, parameters["Proxies"]["EboMoods"])
...
class Implements:
    def __init__(self, ice_connector:Ice.CommunicatorI, default_handler, parameters):
        ...
        self.juegomirror = self.create_adapter("JuegoMirror", juegomirrorI.JuegoMirrorI(default_handler, ""), parameters["Endpoints"]["JuegoMirror"])
